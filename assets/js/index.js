...
const scrollObserver0 = new IntersectionObserver(function (
  entries,
  scrollObserver0
) {
  entries.forEach((entry) => {
...
const scrollObserver1 = new IntersectionObserver(function (
  entries,
  scrollObserver1
) {
  entries.forEach((entry) => {
...
const scrollObserver2 = new IntersectionObserver(function (
  entries,
  scrollObserver2
) {
  entries.forEach((entry) => {
...
const scrollObserver3 = new IntersectionObserver(function (
  entries,
  scrollObserver3
) {
  entries.forEach((entry) => {
...
const scrollObserver4 = new IntersectionObserver(function (
  entries,
  scrollObserver4
) {
  entries.forEach((entry) => {
...
const scrollObserver5 = new IntersectionObserver(function (
  entries,
  scrollObserver5
) {
  entries.forEach((entry) => {
...
const scrollObserver6 = new IntersectionObserver(function (
  entries,
  scrollObserver6
) {
  entries.forEach((entry) => {
...
const scrollObserver7 = new IntersectionObserver(function (
  entries,
  scrollObserver7
) {
  entries.forEach((entry) => {
